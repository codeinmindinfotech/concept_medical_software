document.addEventListener('DOMContentLoaded', function () {
  ...
  channel.bind('notification.received', function (data) {
      ...
      //         <span class="notification-text">${data.data.message ?? 'New message'} 12345</span>
      //     </div>
      ...
      mediaBody.classList.add('media-body', 'flex-grow-1');

      // Notification details
      const details = document.createElement('p');
      details.classList.add('noti-details');
      details.innerHTML = `
      <span class="noti-title">${sender}    </span>   
      ${message}
      `;
...
// Append to list
// document.querySelector('.notification-list').prepend(li);
          ...
          //         <span class="notification-text">${notification.data.message ?? 'New message'} 98765</span>
          //     </div>
