...
<div class="tab-pane fade show active" id="tasks" role="tabpanel">
    <div class="card mb-4 shadow-sm">
        <div class="card-header d-flex justify-content-between align-items-center  ">
            ...
            <a href="{{ route('recalls.recalls.create', $patient) }}" class="btn bg-primary text-white btn-light btn-sm">
            ...
            <table class="table table-bordered" id="RecallTable">
                ...
                <tbody>
                    ...
                    <tr data-id="{{ $recall->id }}">
                        ...
                        <td>
                            <a href="{{ route('recalls.recalls.edit', ['patient' => $patient, 'recall' => $recall]) }}" class="btn btn-sm btn-warning">
