            ...
            <div class="row g-3">
              ...
              <div class="col-md-4">
                ...
                <div class="input-group">
                  <input id="dob" name="dob" type="text" class="form-control @error('dob') is-invalid @enderror" placeholder="YYYY-MM-DD" value="{{ old('dob', $patient->dob ?? '') }}">
          ...
          <div class="card-body">
            <div class="row g-3">
              ...
              <div class="col-md-4">
                ...
                <select id="preferred_contact_id" name="preferred_contact_id" class="form-select @error('preferred_contact_id') is-invalid @enderror">
            ...
            <div class="row g-3 mt-3">
              <div class="col-12">
                ...
                <textarea id="address" name="address" class="form-control @error('address') is-invalid @enderror" rows="2">{{ old('address', $patient->address ?? '') }}</textarea>
        ...
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <textarea id="medical_history" name="medical_history" class="form-control @error('medical_history') is-invalid @enderror" rows="3">{{ old('medical_history', $patient->medical_history ?? '') }}</textarea>
            ...
            <div class="mb-3">
              ...
              <textarea id="referral_reason" name="referral_reason" class="form-control @error('referral_reason') is-invalid @enderror" rows="2">{{ old('referral_reason', $patient->referral_reason ?? '') }}</textarea>
            ...
            <div class="mb-3">
              ...
              <textarea id="symptoms" name="symptoms" class="form-control @error('symptoms') is-invalid @enderror" rows="2">{{ old('symptoms', $patient->symptoms ?? '') }}</textarea>
            ...
            <div class="mb-3">
              ...
              <textarea id="patient_needs" name="patient_needs" class="form-control @error('patient_needs') is-invalid @enderror" rows="2">{{ old('patient_needs', $patient->patient_needs ?? '') }}</textarea>
            ...
            <div class="mb-3">
              ...
              <textarea id="allergies" name="allergies" class="form-control @error('allergies') is-invalid @enderror" rows="2">{{ old('allergies', $patient->allergies ?? '') }}</textarea>
              @error('allergies') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
            <div class="mb-3">
              <label for="diagnosis" class="form-label"><strong>Diagnosis</strong></label>
              <textarea id="diagnosis" name="diagnosis" class="form-control @error('diagnosis') is-invalid @enderror" rows="2">{{ old('diagnosis', $patient->diagnosis ?? '') }}</textarea>
          ...
          <div class="card-body">
            <div class="row align-items-center g-3">
              <div class="col-md-2 form-check">
                <input id="rip" name="rip" type="checkbox" class="form-check-input" value="1" {{ old('rip', $patient->rip ?? false) ? 'checked' : '' }}>
              ...
              <div class="col-md-4">
                ...
                <div class="input-group">
                  <input id="rip_date" name="rip_date" type="text" class="form-control @error('rip_date') is-invalid @enderror" placeholder="YYYY-MM-DD" value="{{ old('rip_date', $patient->rip_date ?? '') }}">
                  <span class="input-group-text"><i class="fa-regular fa-calendar"></i></span>
                  @error('rip_date') <div class="invalid-feedback d-block">{{ $message }}</div> @enderror
                </div>
              </div>
              <div class="col-md-3 form-check">
                <input id="sms_consent" name="sms_consent" type="checkbox" class="form-check-input" value="1" {{ old('sms_consent', $patient->sms_consent ?? false) ? 'checked' : '' }}>
                <label for="sms_consent" class="form-check-label">SMS Consent</label>
              </div>
              <div class="col-md-3 form-check">
                <input id="email_consent" name="email_consent" type="checkbox" class="form-check-input" value="1" {{ old('email_consent', $patient->email_consent ?? false) ? 'checked' : '' }}>
