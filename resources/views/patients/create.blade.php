...
<div class="container-fluid px-4">
    ...
    <form action="{{ route('patients.store') }}" method="POST" class="validate-form">
        ...
        <div class="row mb-3">
            <div class="col-md-4">
                <label for="title_id" class="form-label"><strong>Title</strong></label>
        ...
        <div class="mb-3">
            ...
            <textarea name="address" id="address" class="form-control" rows="2" placeholder="Patient address">{{ old('address') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="medical_history" id="medical_history" class="form-control" rows="3" placeholder="Medical history or notes">{{ old('medical_history') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="referral_reason" id="referral_reason" class="form-control" rows="2" placeholder="Referral reason">{{ old('referral_reason') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="symptoms" id="symptoms" class="form-control" rows="2" placeholder="Symptoms">{{ old('symptoms') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="patient_needs" id="patient_needs" class="form-control" rows="2" placeholder="Patient needs">{{ old('patient_needs') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="allergies" id="allergies" class="form-control" rows="2" placeholder="Allergies">{{ old('allergies') }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea name="diagnosis" id="diagnosis" class="form-control" rows="2" placeholder="Diagnosis">{{ old('diagnosis') }}</textarea>
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="insurance_plan" id="insurance_plan" class="form-control" value="{{ old('insurance_plan') }}" placeholder="Insurance Plan">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="policy_no" id="policy_no" class="form-control" value="{{ old('policy_no') }}" placeholder="Policy Number">
        ...
        <div class="row mb-3 align-items-center">
            <div class="col-md-2">
                <div class="form-check">
                    <input type="checkbox" name="rip" id="rip" class="form-check-input" value="1" {{ old('rip') ? 'checked' : '' }}>
            ...
            <div class="col-md-4">
                ...
                <input type="date" name="rip_date" id="rip_date" class="form-control" value="{{ old('rip_date') }}">
        ...
        <div class="row mb-3">
            <div class="col-md-3">
                <div class="form-check">
                    <input type="checkbox" name="sms_consent" id="sms_consent" class="form-check-input" value="1" {{ old('sms_consent') ? 'checked' : '' }}>
            ...
            <div class="col-md-3">
                <div class="form-check">
                    <input type="checkbox" name="email_consent" id="email_consent" class="form-check-input" value="1" {{ old('email_consent') ? 'checked' : '' }}>
...
@push('scripts')
<script>
    // Optional: Add custom validation or JS here
</script>
@endpush
