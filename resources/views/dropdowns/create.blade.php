        ...
        <form action="{{guard_route('dropdowns.store') }}" method="POST">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" id="code" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="CODE_TYPE" oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9_]/g, '')">
