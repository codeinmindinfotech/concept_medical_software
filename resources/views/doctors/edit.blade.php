                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div id="uploadBox" class="col-md-6" style="display:none;">
                                        <form id="browseUploadForm" action="{{ guard_route('doctor.upload-picture', $doctor->id) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                    ...
                                    <div id="webcamBox" class="col-md-6" style="display:none;">
                                        ...
                                        <form id="webcamForm" action="{{ guard_route('doctor.upload-picture', $doctor->id) }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="doctor_id" value="{{ $doctor->id }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div>
                                            <img src="{{ asset('storage/' . $doctor->doctor_picture) }}" width="150" height="100" class="img-thumbnail">
                                        </div>
                                    </div>
                                    @endif
