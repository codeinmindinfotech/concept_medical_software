                        ...
                        <div class="card-body">
                                            ...
                                            <form method="GET" action="{{ guard_route('patients.index') }}">
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <input type="text" name="phone" id="phone" class="form-control" placeholder="e.g. 0123456789" value="{{ request('phone') }}">
                                                    </div>
                                                    <div class="col-md-4">
                                                        <label for="pin" class="form-label">PIN</label>
                                                        <input type="text" name="pin" id="pin" class="form-control" placeholder="e.g. 123456" value="{{ request('pin') }}">
                                                    </div>
                                                    <div class="col-md-4">
                            ...
                            <ul class="nav nav-tabs nav-tabs-bottom" id="patientTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link {{ request('tab') !== 'trashed' ? 'active' : '' }}" href="{{ guard_route('patients.index') }}">
                                        Active Patients
                                    </a>
                                </li>
                                @if (has_role('superadmin') || has_role('manager'))
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link {{ request('tab') === 'trashed' ? 'active' : '' }}" href="{{ guard_route('patients.index', ['tab' => 'trashed']) }}">
                                        Trashed Patients
                                    </a>
                                </li>
                                @endif
