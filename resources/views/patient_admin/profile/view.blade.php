        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <ul class="nav nav-tabs nav-tabs-bottom">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="note-tab" data-bs-toggle="tab" data-bs-target="#note" role="tab">
                            <i class="fas fa-sticky-note me-1"></i>Notes
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="physical-notes-tab" data-bs-toggle="tab" data-bs-target="#physical-notes" role="tab">
                            <i class="fas fa-stethoscope me-1"></i>Physical Exams
                        </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a class="nav-link" id="history-notes-tab" data-bs-toggle="tab" data-bs-target="#history-notes" role="tab">
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="audio" role="tabpanel" aria-labelledby="audio-tab">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            @can('update', $patient)
                            <a href="{{guard_route('patients.audio.create',$patient->id) }}" class="btn btn-sm btn-primary">
                            ...
                            <div class="col-md-6">
                                <div class="card shadow-sm border-0 rounded-3 h-100">
                                    <div class="card-body d-flex flex-column justify-content-between h-100">
                                        ...
                                        <div>
                                            <a class="btn btn-sm btn-outline-info w-100 show-transcription-btn" data-bs-toggle="modal" data-bs-target="#transcriptionModal" data-transcription="{{ e($audio->transcription) }}" data-title="Transcription ({{ $audio->created_at->format('d M Y') }})">
