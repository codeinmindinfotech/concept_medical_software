...
@slot('title') Task Notification @endslot
@slot('li_1') Notification @endslot
@slot('li_2') Task Notification @endslot
@endcomponent
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover align-middle text-nowrap" id="recallNotificationTable">
                                        <thead>
                                            <tr>
                                                <th>Owner</th>
                                                <th>Patient</th>
